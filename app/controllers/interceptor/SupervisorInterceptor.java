	...
	public static void checkRight() {
		...
		if (!currSupervisor.haveRight(action)) {
			...
			if(currSupervisor.haveLeft(action)){
				...
				}else if(action.startsWith("newr.supervisor.projectManager")){  //add 2016
				    map.put("leftbar", "newr/supervisor/projectManager/projectManagerLeft.control");
			    }else if(action.startsWith("newr.supervisor.bidManager")){
			    	map.put("leftbar", "newr/supervisor/bidManager/bidManagerLeft.control");
