...
public class Page  implements Serializable{
	...
	private String getForeGroundThemeScript(){
		...
		int up = (currPage-1 == 0?1:currPage-1);
		if(currPage != 1){
			strBuff.append("<span class=\"xf_wylc_page_prev\" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+");\">上一页</span>");
		}
		...
		if(showPageCount != 2){
			...
			for(i = inter[0]; i <=inter[1]; i++ ){
				...
				if(sum == showPageCount){
					...
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_ishot\" onclick=\"javascript:"+defaultMethod+"("+totalPageCount+","+pageSize+")\"><a href=\"javascript:void(0);\">总页数："+totalPageCount+"</a></span>");
					break;
				}
				sum ++;
				if(currPage == i){
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_ishot now\" onclick=\"javascript:"+defaultMethod+"("+i+","+pageSize+")\"><a href=\"javascript:void(0);\">"+i+"</a></span>");
				}else{
			...
			if(currPage == 1){
				if(currPage==up){
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_ishot now\" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+")\">"+up+"</span>");
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_rele \" onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">"+down+"</span>");
				}
				if(currPage==down){	
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_ishot \" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+")\">"+up+"</span>");
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_rele now\" onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">"+down+"</span>");
				}
			}else{
				if(currPage==up){
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_rele now\" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+")\">"+up+"</span>");
					strBuff.append("&nbsp;<span class=\"xf_wylc_page_ishot\" onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">"+down+"</span>");
				}
                 if(currPage==down){
                	 strBuff.append("&nbsp;<span class=\"xf_wylc_page_rele\" onclick=\"javascript:"+defaultMethod+"("+up+","+pageSize+")\">"+up+"</span>");
 					 strBuff.append("&nbsp;<span class=\"xf_wylc_page_ishot now\" onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">"+down+"</span>"); 
                 }
			}
		}
		
		if(currPage != totalPageCount){
			strBuff.append("&nbsp;<span class=\"xf_wylc_page_next\" onclick=\"javascript:"+defaultMethod+"("+down+","+pageSize+")\">下一页</span>");
		}
